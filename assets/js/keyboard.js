...
`].filter(ki).join(`
`)),o=Co(o),o=Ja(o,e),o=Qa(o,e),a=Co(a),a=Ja(a,e),a=Qa(a,e),o=tl(o),a=tl(a),e.isRawShaderMaterial!==!0&&(y=`#version 300 es
...
`)+`
`+h);const b=y+p+o,E=y+h+a,F=$a(s,s.VERTEX_SHADER,b),R=$a(s,s.FRAGMENT_SHADER,E);s.attachShader(g,F),s.attachShader(g,R),e.index0AttributeName!==void 0?s.bindAttribLocation(g,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(g,0,"position"),s.linkProgram(g);function w(A){if(i.debug.checkShaderErrors){const L=s.getProgramInfoLog(g).trim(),O=s.getShaderInfoLog(F).trim(),V=s.getShaderInfoLog(R).trim();let D=!0,B=!0;if(s.getProgramParameter(g,s.LINK_STATUS)===!1)if(D=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,g,F,R);else{const H=Ka(s,F,"vertex"),z=Ka(s,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(g,s.VALIDATE_STATUS)+`
